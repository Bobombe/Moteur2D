...
class Moteur2D
{
 ...
 ///////////          METHODES             ///////////
/////////////////////////////////////////////////////
        void init(int width=800, int height=600, std::string windowName ="Start The Screen ! Controls : S and D Keys plus Arrow Keys");
        void run();
        void updateView();
 ...
 ///////////           ADDERS              ///////////
/////////////////////////////////////////////////////
        void addAnimatedTextures(FixedSprite* fs);
 ...
 ///////////          DELETERS             ///////////
/////////////////////////////////////////////////////
        void deleteAnimatedTexture(FixedSprite*fs);
 ...
 ///////////           GETTERS             ///////////
/////////////////////////////////////////////////////
        sf::Texture* getTexture(const std::string& imagePath, bool reapetable = false);
    ...
    protected:
        ...
        std::vector <FixedSprite*> m_animatedTextures;
